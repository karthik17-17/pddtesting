...
- **Deployment URL**: https://neurostay-g2ikgnmv2-munil8215-9361s-projects.vercel.app
- **Execution Date**: 7/23/2026, 2:03:02 PM
- **Target Browser**: Chrome (Headless)
- **OS Version**: Ubuntu/ChromeOS
- **App Version**: 1.0.0-web
- **Total Duration**: 51.33 seconds

## 📊 Execution Metrics

| Metric | Count | Percentage |
| :--- | :---: | :---: |
| **Total Test Cases** | 400 | 100% |
| **✅ Passed** | 396 | **99.0%** |
| **❌ Failed** | 4 | 1.0% |
| **⚠️ Skipped** | 0 | 0.0% |
| **🚫 Blocked** | 0 | 0.0% |
...
✗ **TC_NAV_003** - Navigation validation check - Scenario 3
  *Reason:* element ("a[href$="/"]") still not displayed after 5000ms

✗ **TC_CRUD_005** - CRUD Operations validation check - Scenario 5
  *Reason:* element ("a[href$="/profile"]") still not displayed after 5000ms
