                ...
                if (response.ok) {
                    ...
                    if (Array.isArray(properties) && properties.length > 0) {
                        ...
                        return properties.map((hotel, index) => {
                            ...
                            const priceText = ((_a = hotel.rate_per_night) === null || _a === void 0 ? void 0 : _a.lowest) || "₹2,000";
                            ...
                            return {
                                ...
                                mapLink: hotel.link ||
                                    `https://www.google.com/maps/search/${encodeURIComponent((hotel.name || "") + " " + cleanQuery)}`,
                                lat: ((_d = hotel.gps_coordinates) === null || _d === void 0 ? void 0 : _d.latitude) || null,
                                lng: ((_e = hotel.gps_coordinates) === null || _e === void 0 ? void 0 : _e.longitude) || null,
                                matchScore,
...
function generateFallbackHotels(query) {
